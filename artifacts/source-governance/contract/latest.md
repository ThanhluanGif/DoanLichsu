...
- Run: f1da2e7e
- Generated: 2026-08-09T14:51:36.482Z
- Base URL: http://127.0.0.1:3120
- Planning operations: 43
- Runtime operations: 43
- Cases: 217/217 passed
- Live response schemas validated: 198
- Protected operations probed without a session: 28
- Allowed-role probes: 72
- Denied-role probes: 12
- Drift: 0 missing, 0 extra, 0 shape
- Identity: verified marker over en/ARTIFACT/bach-dang-wooden-stakes; baseline sha256=234809cf67fb0154eb6c6dcdb5ea61dcf9c410051610f1529dd947aa6922f166
- Cleanup: verified exact run-owned teardown and baseline sha256=234809cf67fb0154eb6c6dcdb5ea61dcf9c410051610f1529dd947aa6922f166: contentNodes=50, translations=100, sources=50, claims=0, claimEvidence=0, media=10, users=3, auditLogs=0, rateLimits=0, schemaVersion=4
- Live URLs:
  - http://127.0.0.1:3120/healthz
  - http://127.0.0.1:3120/openapi.json
  - http://127.0.0.1:3120/docs
  - http://127.0.0.1:3120/sitemap.xml
  - http://127.0.0.1:3120/robots.txt
  - http://127.0.0.1:3120/api/v1/vi/home
...
| PASS | rbac.unauthenticated.get./api/v1/admin/contents/{id}/claims | 401 |  |
| PASS | rbac.unauthenticated.post./api/v1/admin/contents/{id}/claims | 401 |  |
| PASS | rbac.unauthenticated.patch./api/v1/admin/contents/{id}/claims/{claimId} | 401 |  |
| PASS | rbac.unauthenticated.post./api/v1/admin/contents/{id}/claims/{claimId}/verification | 401 |  |
...
| PASS | rbac.unauthenticated.post./api/v1/admin/sources/{id}/verification | 401 |  |
...
| PASS | rbac.allowed.get./api/v1/admin/contents/{id}/claims.admin | 200 |  |
| PASS | rbac.allowed.get./api/v1/admin/contents/{id}/claims.editor | 200 |  |
| PASS | rbac.allowed.get./api/v1/admin/contents/{id}/claims.reviewer | 200 |  |
| PASS | rbac.allowed.post./api/v1/admin/contents/{id}/claims.admin | 400 |  |
| PASS | rbac.allowed.post./api/v1/admin/contents/{id}/claims.editor | 400 |  |
| PASS | rbac.allowed.post./api/v1/admin/contents/{id}/claims.reviewer | 400 |  |
| PASS | rbac.allowed.patch./api/v1/admin/contents/{id}/claims/{claimId}.admin | 400 |  |
| PASS | rbac.allowed.patch./api/v1/admin/contents/{id}/claims/{claimId}.editor | 400 |  |
| PASS | rbac.allowed.patch./api/v1/admin/contents/{id}/claims/{claimId}.reviewer | 400 |  |
| PASS | rbac.allowed.post./api/v1/admin/contents/{id}/claims/{claimId}/verification.admin | 400 |  |
| PASS | rbac.allowed.post./api/v1/admin/contents/{id}/claims/{claimId}/verification.editor | 400 |  |
| PASS | rbac.allowed.post./api/v1/admin/contents/{id}/claims/{claimId}/verification.reviewer | 400 |  |
...
| PASS | rbac.allowed.post./api/v1/admin/sources/{id}/verification.admin | 400 |  |
| PASS | rbac.allowed.post./api/v1/admin/sources/{id}/verification.editor | 400 |  |
| PASS | rbac.allowed.post./api/v1/admin/sources/{id}/verification.reviewer | 400 |  |
...
| PASS | admin.source.submit-review | 200 |  |
| PASS | workflow.editor-source-verify-forbidden | 403 |  |
| PASS | admin.source.verify | 200 |  |
...
| PASS | admin.claim.create | 201 |  |
| PASS | admin.claim.list | 200 |  |
| PASS | admin.claim.submit-review | 200 |  |
| PASS | workflow.editor-claim-verify-forbidden | 403 |  |
| PASS | admin.claim.verify | 200 |  |
...
| PASS | diagnostic.intentional-openapi-mutation | — | schema SourceInput: property mismatch expected=[accessedAt,archivedUrl,author,checksum,citationNote,edition,identifier,institution,publisher,qualityTier,sourceType,title,url,year] OpenAPI=[accessedAt,archivedUrl,checksum,citationNote,edition,identifier,institution,publisher,qualityTier,sourceType,title,url,year] |
