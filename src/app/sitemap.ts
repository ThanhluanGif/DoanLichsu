...
import { absolutePublicUrl,archivePath,contentCollectionPath,contentPath,homePath,learnByGradePath,sourcesPath,timelinePath } from "@/lib/public-client/paths";
